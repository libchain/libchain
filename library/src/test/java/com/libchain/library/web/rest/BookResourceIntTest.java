...
import com.libchain.library.repository.BookRepository;
...
public class BookResourceIntTest {
    ...
    public void createBook() throws Exception {
        ...
        assertThat(testBook.getPubKey()).isEqualTo(DEFAULT_PUB_KEY);
    }
    ...
    public void updateBook() throws Exception {
        ...
        assertThat(testBook.getPubKey()).isEqualTo(UPDATED_PUB_KEY);
    }
