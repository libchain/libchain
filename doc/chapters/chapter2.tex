...
\section{Problems and Limitations}
 % * out of gas and poor documentation
 % * performance & confirmation times
 % * unknown gas usage before function calls
 % * solidity --> mapping / array limitations (iterability)
 % 			--> example how we solved it in LibChain
